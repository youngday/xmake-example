...
static void set_codec_params(const AVCodec *codec, AVPixelFormat pix_fmt, AVFormatContext *fctx, AVCodecContext *codec_ctx, int width, int height, int fps, int bitrate)
{
...
static int initialize_codec(AVStream *stream, AVCodecContext *codec_ctx, const AVCodec *codec, const std::map<std::string, std::string> &codec_options)
{
    int ret;
...
static int initialize_codec(AVCodecContext *codec_ctx, const AVCodec *codec, const std::map<std::string, std::string> &codec_options)
{
    int ret;
...
static const AVCodec *find_encoder_by_name(const char *name, enum AVMediaType type)
{
